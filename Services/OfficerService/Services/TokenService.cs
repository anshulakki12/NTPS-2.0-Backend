...
namespace OfficerService.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenResult GenerateToken(OfficerRegistration officer, MasterRoles role)
        {
            var claims = new List<Claim>
            {
                ...
                new Claim("LoginId", officer.LoginId ?? string.Empty),
                new Claim("LocationId", officer.LocationId.ToString()),
                new Claim("LocationType", officer.LocationType.ToString()),
                new Claim("IsActive", officer.IsActive.ToString()),
                new Claim("UserType", "Officer"), // For easy identification
            ...
            if (officer.OfficerDetails != null)
            {
                ...
                claims.Add(new Claim("OfficerName", officer.OfficerDetails.OfficerName ?? string.Empty));
